...
user1 = User(username = 'Prateek Shrivastava' , email = 'prateek.s2811@gmail.com')
session.add(user1)
session.commit()
...
car1 = car(user_id = user1.id , name = " Corola Aultis",
           description = "The Toyota Corola Aultis , is a luxury siden car and one of the most selling car by Toyota.",
